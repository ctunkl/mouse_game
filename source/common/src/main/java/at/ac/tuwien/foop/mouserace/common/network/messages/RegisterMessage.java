 ...
 */
public class RegisterMessage extends CommandMessage {
	private static final Logger logger = LoggerFactory.getLogger(RegisterMessage.class.getName());

	public static final CommandType COMMAND_TYPE = CommandType.REGISTER;
	 ...
	 */
	public static RegisterMessage fromByteArray(byte[] data) throws EOFException, MessageParsingException {
	 ...
	 * @throws EOFException            if the input provided is shorter than the expected length
	 */
	public static RegisterMessage fromInputStream(DataInput input) throws MessageParsingException, IOException {
