 ...
 */
public class RegisterAckMessage extends CommandMessage {
	private static final Logger logger = LoggerFactory.getLogger(RegisterAckMessage.class.getName());

	public static final CommandType COMMAND_TYPE = CommandType.REGISTER_ACK;
	 ...
	 */
	public static RegisterAckMessage fromByteArray(byte[] data) throws EOFException, MessageParsingException {
	 ...
	 * @throws EOFException            if the input provided is shorter than the expected length
	 */
	public static RegisterAckMessage fromInputStream(DataInput input) throws MessageParsingException, IOException {
