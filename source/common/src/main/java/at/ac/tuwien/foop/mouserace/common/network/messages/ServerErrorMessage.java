 ...
 */
public class ServerErrorMessage extends CommandMessage {
	private static final Logger logger = LoggerFactory.getLogger(ServerErrorMessage.class.getName());

	public static final CommandType COMMAND_TYPE = CommandType.SERVER_ERROR;
	 ...
	 */
	public static ServerErrorMessage fromByteArray(byte[] data) throws EOFException, MessageParsingException {
	 ...
	 * @throws EOFException            if the input provided is shorter than the expected length
	 */
	public static ServerErrorMessage fromInputStream(DataInput input) throws MessageParsingException, IOException {
