...
public class StartMessage extends CommandMessage {
	private static final Logger logger = LoggerFactory.getLogger(StartMessage.class.getName());

	public static final CommandType COMMAND_TYPE = CommandType.START;
	 ...
	 */
	public static StartMessage fromByteArray(byte[] data) throws EOFException, MessageParsingException {
	 ...
	 * @throws EOFException            if the input provided is shorter than the expected length
	 */
	public static StartMessage fromInputStream(DataInput input) throws MessageParsingException, IOException {
